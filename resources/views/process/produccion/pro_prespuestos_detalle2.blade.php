@extends('layouts.inicio_process2')
...
<div class = 'ContentPanelxx' style = 'width:100%;'>
    <div class = 'form-row'>
    ...
    <div class = 'table'>
        ...
        @if( $Datos[0]->Estado_Presupuesto == 'Pendiente Aprobación Cliente' )
            ...
            <a href="../6f4926481edc1ae3b08f31d5b2689ef8/{{$Datos[0]->Hash}}" target = '_blank'>
                ...
                <span class="FirstText Cursor" style="color:#1B4075;" > Imprimir Presupuesto Cliente sin Proveedores </span>
            </a>

            <a href="../6f4926481edc1ae3b08f31d5b2689ef8as/{{$Datos[0]->Hash}}" target = '_blank' >
                <img src ='../images/datos_additem.png' class = 'OptionIcon' style ="padding-left:10px;"/>
                <span class="FirstText Cursor" style="color:#1B4075;" > Imprimir Presupuesto Cliente con Proveedores </span>
            </a>
    ...
    <!-- CONTENIDO PPTO -->
    <div class="ContenedorMenu ContenedorDataPpto" style = 'height: 280px;border:0px;overflow: none;'>
        @if( $Datos[0]->VersionCerrada == 0 )
            @foreach($Datos[0]->Grupos as $g)
                <table class = 'Ppto_TablaContenidoGrupo Grupo{{$g->Hash}}' style = 'width:100%;'>
                    <tr>
                        <td style = 'vertical-position:middle;'>
                            <span class = 'HidenInformation GruposIds'>{{$g->Hash}}</span>
                                <table width = '100%' class = 'TituloTablasResumen'>
                                    <tr>
                                        @if( $Datos[0]->Estado_Presupuesto == 'En Construcción' )
                                            <td class='BlackFont '   nowrap style = 'color:white;'>
                                                <i class="far fa-trash-alt OptionIcon" style ='font-size:15px'  onclick = 'EliminarGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})' title="Eliminar"></i>
                                            </td>
                                        @endif

                                        <td  class='BlackFont CenterText' style = 'color:white;vertical-align: bottom;'nowrap>
                                            <i class="fas fa-edit OptionIcon" style ='font-size:15px'  onclick = 'EditarGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})' title="Editar" data-toggle='modal' data-target='#ModalEdit'></i>
                                        </td>
                                        <td  class='BlackFont CenterText' style = 'color:white;'nowrap>
                                            <i class="far fa-plus-square OptionIcon" style ='font-size:15px' onclick = 'CrearItemGrupo({{$Datos[0]->Hash}},{{$g->Hash}})' title="Agregar Item"></i>
                                        </td>
                                        <td  class='BlackFont CenterText' style = 'color:white;'nowrap>
                                            <i class="fas fa-sort OptionIcon" style ='font-size:15px' onclick = "ReorganizarItemsGruposPpto({{$Datos[0]->url}})" title="Reorganizar Items"data-toggle="modal" data-target="#ModalEdit"></i>
                                        </td>


                                        <td width='95%' class='CenterText NameGrup{{$g->Hash}}' style ='vertical-align:middle;font-size:15px;color:white;text-align:left;' nowrap >{{$g->Grupo}}</td>
                                    </tr>
                                </table>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class = 'ContenedorItemsGrupos HidenInformation' style = 'overflow-y: scroll;'>
                                <table width ='100%'>
                                    <tr>
                                        <th colspan = '20' class = 'PptoTituloInterno'>INTERNO</th>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class = 'PptoSubTituloInterno HidenInformation' nowrap>Sel.</td>
                                        <td class = 'PptoSubTituloInterno' nowrap>Anticipo</td>
                                        <td class = 'PptoSubTituloInterno' nowrap>Comisión<br>Cliente</td>
                                        <td class = 'PptoSubTituloInterno' nowrap>No<br>Comisional</td>
                                            ...
                                            @foreach( $g->ItemsGrupo as $Item )
                                                <tr class = 'Items ItemGrupo{{$g->Hash}} ItemI{{$Item->Hash}} Cursor_AS '>
                                                        ...
                                                        <td class = 'Presupuesto_Cuerpo CenterText'>
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1 )

                                                            @else
                                                                <i class="far fa-trash-alt" style ='font-size:15px'  onclick = 'EliminarItemGrupoPpto({{$Datos[0]->Hash}},{{$Item->Hash}})'></i>
                                                            @endif

                                                        </td>
                                                        <td class = 'HidenInformation OrdenItemGrupoPptoId IdsItesm{{$g->Hash}}' >{{$Item->Hash}}</td>
                                                        ...
                                                        <td class = 'Presupuesto_Cuerpo CenterText ComisionCliente{{$Item->Hash}}'>
                                                            ...
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1)
                                                                @if( $Item->VC == 1 )
                                                                    <input type="radio" class = 'RadioSize'checked="">
                                                                @else
                                                                    <input type="radio" class = 'RadioSize' >
                                                                @endif
                                                            @else
                                                                @if( $Item->VC == 1 )
                                                                    <input type="radio" class = 'RadioSize' onclick = 'InhabilitarComisionClienteItem({{$Item->Hash}})' checked="">
                                                                @else
                                                                    <input type="radio" class = 'RadioSize' onclick = 'InhabilitarComisionClienteItem({{$Item->Hash}})'>
                                                                @endif
                                                            @endif
                                                            <span class = 'HidenInformation VC VC{{$Item->Hash}}'>{{$Item->VC}}</span>
                                                        </td>
                                                        <td class = 'TablaReportes_Cuerpo_Center CenterText'>
                                                            <input type="radio" class = 'RadioSize' >
                                                        </td>
                                                        ...
                                                        <td class = 'Presupuesto_Cuerpo TablaReportes_Cuerpo'>
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1)
                                                                <input autocomplete = 'off' type = 'number' onchange = "CalcularAllPpto({{$Datos[0]->Id}})" disabled onkeyup = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});' oninput = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});' class = 'form-control PptoCamposSmall' step='0.1' id = 'DiasItem{{$Item->Hash}}' min = '0' value = '{{$Item->Dias}}' name = 'DiasItem{{$Item->Hash}}[]' />
                                                            @else
                                                                <input autocomplete = 'off' type = 'number' onchange = "CalcularAllPpto({{$Datos[0]->Id}})" onkeyup = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});' oninput = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});' class = 'form-control PptoCamposSmall' step='0.1' id = 'DiasItem{{$Item->Hash}}' min = '0' value = '{{$Item->Dias}}' name = 'DiasItem{{$Item->Hash}}[]' />
                                                            @endif

                                                        </td>
                                                        <td class = 'Presupuesto_Cuerpo'>
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1)
                                                                <input autocomplete = 'off' type = 'number' onchange = "CalcularAllPpto({{$Datos[0]->Id}})" onkeyup = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});' oninput = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})' class = 'form-control PptoCamposSmall' disabled step='0.1' id = 'CantidadItem{{$Item->Hash}}'  min = '0'value = '{{$Item->Unidad}}' name = 'CantidadItem{{$Item->Hash}}[]' />
                                                            @else
                                                                <input autocomplete = 'off' type = 'number'  onchange = "CalcularAllPpto({{$Datos[0]->Id}})" onkeyup = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});' oninput = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})' class = 'form-control PptoCamposSmall' step='0.1' id = 'CantidadItem{{$Item->Hash}}' value = '{{$Item->Unidad}}'  min = '0' name = 'CantidadItem{{$Item->Hash}}[]' />
                                                            @endif

                                                        </td>
                                                        <td class = 'Presupuesto_Cuerpo '>
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1)
                                                                <input autocomplete = 'off' type = 'text' disabled name = 'ValorUnitarioInterno{{$Item->Hash}}[]' id = 'ValorUnitarioInterno{{$Item->Hash}}' value = '{{$Item->ValorUnitario}}' onkeyup = "FormatCampoNumPpto('ValorUnitarioInterno{{$Item->Hash}}','ValorUnitarioInterno{{$Item->Hash}}_real');CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});" onchange = "CalcularAllPpto({{$Datos[0]->Id}})" class = 'PptoCamposSmall ValorUnitarioInterno{{$Item->Hash}} form-control' required />
                                                            @else
                                                                <input autocomplete = 'off' type = 'text' name = 'ValorUnitarioInterno{{$Item->Hash}}[]' id = 'ValorUnitarioInterno{{$Item->Hash}}' value = '{{$Item->ValorUnitario}}' onkeyup = "FormatCampoNumPpto('ValorUnitarioInterno{{$Item->Hash}}','ValorUnitarioInterno{{$Item->Hash}}_real');CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}});" onchange = "CalcularAllPpto({{$Datos[0]->Id}})" class = 'PptoCamposSmall ValorUnitarioInterno{{$Item->Hash}} form-control' required />
                                                            @endif
                                                        ...
                                                        <td class = 'Presupuesto_Cuerpo'>
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1)
                                                                <input autocomplete = 'off' type = 'number' onkeyup = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})'  min = '0' oninput = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})'  class = 'form-control PptoCamposSmall' step='0.1' id = 'VolumenItem{{$Item->Hash}}' disabled value = '{{$Item->Volumen}}' name = 'VolumenItem{{$Item->Hash}}[]' />
                                                            @else
                                                                <input autocomplete = 'off' type = 'number' onkeyup = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})'  min = '0' oninput = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})'  class = 'form-control PptoCamposSmall' step='0.1' id = 'VolumenItem{{$Item->Hash}}' value = '{{$Item->Volumen}}' name = 'VolumenItem{{$Item->Hash}}[]' />
                                                            @endif
                                                        ...
                                                        <td class = 'Presupuesto_Cuerpo '>
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1)
                                                                <input autocomplete = 'off' type = 'text' name = 'ValorUnitarioExterno{{$Item->Hash}}[]' id = 'ValorUnitarioExterno{{$Item->Hash}}' value = '{{$Item->ValorUnitarioCliente}}' onkeyup = "FormatCampoNumPpto('ValorUnitarioExterno{{$Item->Hash}}','ValorUnitarioExterno{{$Item->Hash}}_real');CalcularAllPpto({{$Datos[0]->Id}});" disabled class = 'PptoCamposSmall ValorUnitarioExterno{{$Item->Hash}} form-control' required />
                                                            @else
                                                                <input autocomplete = 'off' type = 'text' name = 'ValorUnitarioExterno{{$Item->Hash}}[]' id = 'ValorUnitarioExterno{{$Item->Hash}}' value = '{{$Item->ValorUnitarioCliente}}' onkeyup = "FormatCampoNumPpto('ValorUnitarioExterno{{$Item->Hash}}','ValorUnitarioExterno{{$Item->Hash}}_real');" class = 'PptoCamposSmall ValorUnitarioExterno{{$Item->Hash}} form-control' required />
                                                            @endif
                                                        ...
                                                        <td class = 'Presupuesto_Cuerpo'>
                                                            @if( $Item->IdOc != '' || $Item->Anticipo == 1)
                                                                <input autocomplete = 'off' disabled type = 'number' class = 'form-control PptoCamposSmall' onkeyup = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})' oninput = 'CalcularCostoGrupoPpto({{$Datos[0]->Hash}},{{$g->Hash}})'   step='0.1' id = 'ComisionItem{{$Item->Hash}}' value= '{{$Item->PorcentajeComision}}'name = 'ComisionItem{{$Item->Hash}}[]' />
                                                            @else
                                    ...
                                    <tr>
                                        <th colspan = '14' class = 'PptoTituloInterno_Bottom'>Total</th>
