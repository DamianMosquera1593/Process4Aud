                        ...
                        <td class = 'TdItems' style = 'width:15%;'>
                            <table width ='100%'>
                                <tr>
                                    <td style = 'width:20%;text-align:right;'>$</td>
                                    <td style = 'text-align:right;'>
                                        @if( $item->SubtotalUnitario != 0 )
                                            @php
                                                echo number_format( ($item->TotalUnitario) - ($item->SubtotalUnitario),2)
                                            @endphp
                                        @else
                                            @php
                    ...
                    <tr>
                        <td colspan = '2' style = 'vertical-align:top;' >
                            <table class ='DetallePpto'>
                                ...
                                @if( count(session("DataPpto")[0]->ImpuestosItems) == 0)
                                    <tr>
                                        <td class = 'CenterText' colspan = '2'>Sin Impuestos</td>
                                    </tr>
                                @endif
                        ...
                        <td style = 'vertical-align:top;'>
                            <table class ='DetallePpto'>
                                ...
                                @if( count(session("DataPpto")[0]->ImpuestosComision) == 0)
                                    <tr>
                                        <td class = 'CenterText TdItems' colspan = '2'>Sin Impuestos</td>
                                    </tr>
                                @endif
                                @foreach( session("DataPpto")[0]->ImpuestosComision as $t )
                                <tr>
                                    <td class = 'TdItems'>{{$t->Tarifa}}</td>
                                    <td class = 'TdItems'>
                                        <table width ='100%'>
                                            <tr>
                                                <td style = 'width:20%;text-align:right;'>$</td>
                        ...
                        <td colspan = '2' style = 'vertical-align:top;'>
                            <table class ='DetallePpto'>
                                ...
                                <tr>
                                    <td class = 'ThSub' style = 'text-align:left;padding-left:5px;'>COMISIÓN</td>
                                    <td class = 'TdItems'>
                                        <table width ='100%'>
                                            <tr>
                                                <td style = 'width:20%;text-align:right;'>$</td>
                                                <td style = 'text-align:right;'>
                                                    @php
                                                        echo number_format(session("DataPpto")[0]->Comision,2)
                                                    @endphp
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class = 'TdItems'>
                                        <table width ='100%'>
                                            <tr>
                                                ...
                                                <td style = 'text-align:right;'>
                                                    @php
                                                        echo number_format(session("DataPpto")[0]->TotalImpuestosComision,2)
                                                    @endphp
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class = 'TdItems'>
                                        <table width ='100%'>
                                            <tr>
                                                ...
                                                <td style = 'text-align:right;'>
                                                    @php
                                                        echo number_format((session("DataPpto")[0]->TotalImpuestosComision + session("DataPpto")[0]->Comision + session("DataPpto")[0]->TotalImpuestos + session("DataPpto")[0]->TotalPptoAntesComision),2)
                                                    @endphp
                                                </td>
                                            </tr>
                                        </table>
