        ...
        <div class = 'ContentPanelCorreo' >
            ...
            <div class = 'BodyInf'>
                ...
                <table class ='DetallePpto'>
                    <tr>
                        <th class = 'CenterText'colspan = '8'>{{$g->Grupo}}</th>
                    </tr>
                    <tr>
                                    ...
                                    <td class = 'TdItems'>
                                        <table width ='100%'>
                                            <tr>
                                                ...
                                                <td style = 'text-align:right;'>
                                                    @php
                                                        echo number_format(session("DataPpto")[0]->TotalImpuestos)
                                                    @endphp
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class = 'TdItems'>
                                        <table width ='100%'>
                                            <tr>
                                                ...
                                                <td style = 'text-align:right;'>
                                                    @php
                                                        echo number_format(session("DataPpto")[0]->TotalImpuestosComision)
                                                    @endphp
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class = 'TdItems'>
                                        <table width ='100%'>
                                            <tr>
                                                ...
                                                <td style = 'text-align:right;'>
                                                    @php
                                                        echo number_format(session("DataPpto")[0]->TotalImpuestosComision + session("DataPpto")[0]->Comision + session("DataPpto")[0]->TotalImpuestos + session("DataPpto")[0]->TotalPptoAntesComision )
                                                    @endphp
                                                </td>
                                            </tr>
                                        </table>
