...
<body>
    <head>
        <meta charset="UTF-8">
        <title>Orden de Producción No. {{session("DataOrden")[0]->Id}}</title>
    </head>
    ...
    <header>
        <table width ='100%'>
            <tr>
                ...
                <td class = 'CenterText'>
                    <span style = 'font-weight: bold; font-size:20px;'>ORDEN DE PRODUCCIÓN # {{session("DataOrden")[0]->Id}}</span><p></p>
